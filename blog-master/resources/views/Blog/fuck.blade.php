        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="./AdminLTE-2.3.11/index2.html" class="navbar-brand"><b>Admin</b>LTE</a>
                ...
                <div class="box box-widget">
                    <div class="box-header with-border">
                        <div class="user-block">
                            <img class="img-circle" src="./AdminLTE-2.3.11/dist/img/user1-128x128.jpg" alt="User Image">
                    ...
                    <div class="box-body">
                        ...
                        {{--<div class="attachment-block clearfix">--}}
                            {{--<img class="attachment-img" src="./AdminLTE-2.3.11/dist/img/photo1.png" alt="Attachment Image">--}}
                            ...
                            {{--<div class="attachment-pushed">--}}
                                ...
                                {{--<div class="attachment-text">--}}
                                    ...
                                    {{--Lorem Ipsum is simply dummy text of the printing and typesetting industry./AdminLTE-2.3.11. <a href="#">more</a>--}}
                                {{--</div>--}}
                                {{--<!-- /.attachment-text -->--}}
                            {{--</div>--}}
                            {{--<!-- /.attachment-pushed -->--}}
                    ...
                    <div class="box-footer">
                        <form action="#" method="post">
                            <img class="img-responsive img-circle img-sm" src="./AdminLTE-2.3.11/dist/img/user4-128x128.jpg" alt="Alt Text">
